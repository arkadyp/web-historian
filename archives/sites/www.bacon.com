...
<head>
<title>bacon.com</title>
<meta name="author" content="modern-template-3" class="home-color"/>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />

<meta http-equiv="Keywords" name="Keywords" content="Bacon, Bacon Brownies, Bacon T-Shirts, Bacon, How to Make Bacon, Bacon Recipes, Canadian Bacon, Halo, Bacon Calories, Prime Rib" />
<meta http-equiv="Description" name="Description" content="For resources and information on Bacon and Bacon Brownies" />

  <noscript>
    <META http-equiv="refresh" CONTENT="0;URL='http://www.bacon.com/?j=-1&d=bacon.com'" />
  </noscript>
...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
  ...
  <script type="text/javascript">
    ...
    'pubId' : "dp-r-va02_js",
    'channel': "000001",
    'resultsPageBaseUrl' : "http://www.bacon.com/search.php?caf",
        'domainRegistrant' : "as-drid-oo-1572282621076058",
    
    'fontFamily' : 'tahoma',
    // domain keywords
    'kw' : "Breakfast recipes",
    ...
    'terms' : "bacon,Bacon Brownies,Bacon T-Shirts,Bacon,How to Make Bacon,Bacon Recipes,Canadian Bacon,Halo,Bacon Calories,Prime Rib",
    ...
    'pageLoadedCallback': function(requestAccepted, status){
        if(!requestAccepted){
            var url = "http://www.bacon.com/?d=bacon.com";
            ...
            window.location = "http://www.bacon.com/?d=bacon.com&fl=1&flr=-1";
        }
    }
};
...
var shortAdBlock = {
    ...
    'type' : 'ads',
    'clicktrackUrl' : 'http://www.bacon.com/caf_clicks.php?caf&pp=6&position=main&type=ad&nterm=',
    // Optional params.
    'linkTarget' : '_blank',
...
var adBlock = {
    ...
    'container' : 'adBlock',
    'type' : 'ads',
    'clicktrackUrl' : 'http://www.bacon.com/caf_clicks.php?caf&pp=7&position=main&type=ad&nterm=',
...
$(document).ready(function(){
    ...
    'adIconUrl' : "http://afs.googleusercontent.com/dp-r/common-home-color-check.gif",
    'adIconWidth' : 20,
    'adIconHeight' : 20,
...
var relKW3ColBlock = {
    ...
    // related keyword icon
    'adIconUrl' : "http://afs.googleusercontent.com/dp-r/common-home-color-bullet-arrow.gif",
    'adIconWidth' : 7,
    'adIconHeight' : 10,
    'adIconSpacingAbove' : 4,
...
var relKWgenBlock3 = {
    ...
    relKWLeftMenuBlock['colorTitleLink'] = '#4f3826';
relKWLeftMenuBlock['colorAdBorder'] = '#B2ACA4';

relKW3ColBlock['colorTitleLink'] = '#4f3826';  </script>

  <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
  <script type="text/javascript">
    $(document).ready(function () {
      var domain_url = "https://mark.com/domains/bacon.com/"
      // top banner
      if ( $('#ceiling_banner').length == 0) {
        var $ceiling_padder = $('<div id="ceiling_padder">&nbsp;</div>');

        var $ceiling_banner = $(document.createElement( "div" ));
        $ceiling_banner.attr('id', 'ceiling_banner').attr('class', 'buy_or_rent mark_banner');
        var $container = $('<div class="container_760"></div>');
        var $inner_container = $('<div class="mark_container"></div>').html('<img id="mark_logo" src="/static/common/images/banner/mark/mark_logo.png" />');

        $inner_container.append('<div class="pull-right">This domain is listed at Mark.com <a target="_blank" class="button buy-domain green">BUY IT</a> <a target="_blank" class="rent-domain button green">RENT IT</a><div>');
        $inner_container.find('a.button.buy-domain').attr('href', (domain_url + 'why-buy'));
        $inner_container.find('a.button.rent-domain').attr('href', (domain_url + 'why-rent'));
...
<!--
	...
	.cattitle {
     ...
     #relatedmenudiv a:hover {
	  ...
	  .relatedbar { vertical-align:top; background : #d1c9be; }//-->
</style>
...
<body>
  <iframe src="/top.php?d=bacon.com"  width=0 height=0 style="hidden" scrolling="no" frameborder="0" marginwidth="0" marginheight="0" noresize="noresize" ></iframe>
<!-- <img id="uniques_log" width="0" height="0" border="0" alt="" src="/uniques.php?d=bacon.com"> -->
<!--   <iframe id="no_js" src="http://www.bacon.com/?j=-1" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%" scrolling="auto"noresize="noresize" style="overflow:hidden;height:100%;width:100%;min-height:700px"></iframe>
  <script type="text/javascript"> 
    var frame = document.getElementById('no_js'); 
    if(frame){frame.parentNode.removeChild(frame);}
    // document.getElementById('uniques_log').src="/uniques.php?d=bacon.com";
  </script>
 -->  <div id="page_content_caf" align="center" style="display:none">
    <table width="760" cellpadding="0" cellspacing="0" border="0" >
            <tr>
        <td width="240">
                      <img src="/static/images/240_100/2648.jpg" alt="" width="240" height="100" border="0" />
                  </td>
        <td width="520">
          <table cellspacing="0" cellpadding="0" border="0" width="520">
            <tr>
              <td width="1" rowspan="2"><img src="/static/common/images/spacer.gif" width="1" height="100" border="0" alt="" /></td>
                            <td width="520" class="title1" style="padding:12px;">Welcome to <a href="http://www.bacon.com" class="domain"><b>bacon.com</b></a></td>
                          </tr>
            <tr>
              <td class="title2">
...
<td width="240" class="relatedbar">
  ...
  <td width="520" style="background: url(/static/images/520_400/6020.jpg) no-repeat 0px -28px; width:520px;">
...
<tr>
  <td colspan="3">
    <img src="/static/common/images/spacer.gif" width="1" height="1" border="0" alt="">
      ...
      <span class="copyright">&copy; 2014 bacon.com. All Rights Reserved.  <a href="inquiry.php">Contact Us</a>  </span>
      <br />
